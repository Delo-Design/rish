...
* MariaDB 10.11, 11.4, 11.8 или 12.3
...
RISH распространяется на условиях [MIT License](LICENSE.txt).

Сторонние компоненты, включённые в состав RISH или устанавливаемые им, распространяются на условиях собственных лицензий.
